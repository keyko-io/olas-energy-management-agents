...
"""This package contains the tests for rounds of Peaq."""
...
class BasePeaqRoundTest(BaseRoundTestClass):
    """Base test class for Peaq rounds."""
...
class TestCollectDataRound(BasePeaqRoundTest):
...
class TestDeviceInteractionRound(BasePeaqRoundTest):
    """Tests for DeviceInteractionRound."""

    round_class = DeviceInteractionRound
...
class TestQueryModelRound(BasePeaqRoundTest):
